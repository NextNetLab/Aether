...
private:
    ...
    std::unique_ptr<cellular_emulation::TwoTierQueueManager> cellular_queue_;
    bool use_cellular_queue_;
    ...
    QueuedPacket dequeue_for_transmission( const uint64_t current_time );
